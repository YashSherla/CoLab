            ...
            <div className="flex flex-col w-full space-y-5">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <div className="flex-1">
                  <p className="text-sm text-gray-500 flex">Project Name<p className="text-red-500">*</p></p>
                ...
                <div className="flex-1">
                  <p className="text-sm text-gray-500 flex">Deadline<p className="text-red-500">*</p></p>
              ...
              <div>
                <p className="text-sm text-gray-500 flex">Description<p className="text-red-500">*</p></p>
              ...
              <div>
                ...
                <input type="file" ref={fileRef} id="input-file-upload" onChange={(e: any) => setFile(e.target.files[0])} multiple={true} className="hidden" />
                <label className="flex flex-col items-center justify-center border-2 border-dashed rounded-md p-6 cursor-pointer border-gray-400 transition h-[10rem]">
                  <div className="text-center items-center flex flex-col" onClick={() => fileRef.current?.click()}>
                  <svg width="80px" height="80px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M13 2.5V5C13 7.35702 13 8.53553 13.7322 9.26777C14.4645 10 15.643 10 18 10H22" stroke="#6b7280" stroke-width="1.5"/>
                  </svg>
              ...
              <div>
                ...
                <div className="grid grid-cols-12 gap-4 items-center px-4">
                  ...
                  <div className="col-span-2 flex items-center justify-end">
                    <p className="text-[#1fb69b] text-xs dark:bg-[#002c27] px-1 rounded-2xl border-2 border-dashed border-[#1fb69b]">100%</p>
                  </div>
                  <div className="col-span-2 flex items-center justify-end">
